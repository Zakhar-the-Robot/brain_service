...
if __name__ == "__main__":
    ...
    while(1):
        ...
        print( "[ 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x\t 0x%x ]" %
            (
                ...
                i2c_read_byte_from(addr,0x8),
                i2c_read_byte_from(addr,0x9),
                i2c_read_byte_from(addr,0xa)
            ))
        # sleep(.1)